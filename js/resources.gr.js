var grResources = {
		...
		Hide:"Κλείσιμο",
		ItineraryPageHeaderNull:'Δεν υπάρχουν διαθέσιμες περιηγήσεις. Επιλέξτε "Φόρτωση από Portal" για να κατεβάσετε τις διαθέσιμες περιηγήσεις απότ την ιστοσελίδα',
